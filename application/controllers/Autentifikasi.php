    ...
    { 
        ...
        if($this->session->userdata('email')){
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->load->view('autentifikasi/login1'); 
